...
class HyperNet(BaseClass):
    def __init__(self, dataset, emb_dim, hidden_drop):
        ...
        self.W0 = torch.nn.Parameter(torch.empty(size=(3*emb_dim, 256)))
        self.W1 = torch.nn.Parameter(torch.empty(size=(2*emb_dim, 256)))
        self.W2 = torch.nn.Parameter(torch.empty(size=(emb_dim, 256)))
        self.W3 = torch.nn.Parameter(torch.empty(size=(emb_dim, 256)))
        self.a = torch.nn.Parameter(torch.empty(size=(256, 1)))
    ...
    def forward(self, batch, ms, bs):
        ...
        if batch.shape[1] == 3:
            ...
            new_e1 = torch.mm(e1, self.W2) + torch.relu(e11*e1_e1_att + e12*e1_e2_att)
            new_e2 = torch.mm(e2, self.W2) + torch.relu(e21*e2_e1_att + e22*e2_e2_att)
            ...
            r = torch.mm(r, self.W3) + torch.relu(re1 * re1_att.view(-1, 1) + re2 * re2_att.view(-1, 1))
            ...
            r = torch.mm(r, self.W3) + torch.relu(re1 * re1_att.view(-1, 1) + re2 * re2_att.view(-1, 1) + re3 * re3_att.view(-1, 1))

            new_e1 = torch.mm(e1, self.W2) + torch.relu(e11*e1_e1_att + e12*e1_e2_att + e13*e1_e3_att)
            new_e2 = torch.mm(e2, self.W2) + torch.relu(e21*e2_e1_att + e22*e2_e2_att + e23*e2_e3_att)
            new_e3 = torch.mm(e3, self.W2) + torch.relu(e31*e3_e1_att + e32*e3_e2_att + e33*e3_e3_att)
            ...
            new_e1 = torch.mm(e1, self.W2) + torch.relu(e11 * e1_e1_att + e12 * e1_e2_att + e13 * e1_e3_att + e14 * e1_e4_att)
            new_e2 = torch.mm(e2, self.W2) + torch.relu(e21 * e2_e1_att + e22 * e2_e2_att + e23 * e2_e3_att + e24 * e2_e4_att)
            new_e3 = torch.mm(e3, self.W2) + torch.relu(e31 * e3_e1_att + e32 * e3_e2_att + e33 * e3_e3_att + e34 * e3_e4_att)
            new_e4 = torch.mm(e4, self.W2) + torch.relu(e41 * e4_e1_att + e42 * e4_e2_att + e43 * e4_e3_att + e44 * e4_e4_att)
            ...
            r = torch.mm(r, self.W3) + torch.relu(re1 * re1_att.view(-1, 1) + re2 * re2_att.view(-1, 1) + re3 * re3_att.view(-1, 1) + re4 * re4_att.view(-1, 1))
            ...
            r = torch.mm(r, self.W3) + torch.relu(re1 * re1_att.view(-1, 1) + re2 * re2_att.view(-1, 1) + re3 * re3_att.view(-1, 1) + re4 * re4_att.view(-1, 1) + re5 * re5_att.view(-1, 1))


            new_e1 = torch.mm(e1, self.W2) + torch.relu(e11*e1_e1_att + e12*e1_e2_att + e13*e1_e3_att + e14*e1_e4_att + e15*e1_e5_att)
            new_e2 = torch.mm(e2, self.W2) + torch.relu(e21*e2_e1_att + e22*e2_e2_att + e23*e2_e3_att + e24*e2_e4_att + e25*e2_e5_att)
            new_e3 = torch.mm(e3, self.W2) + torch.relu(e31*e3_e1_att + e32*e3_e2_att + e33*e3_e3_att + e34*e3_e4_att + e35*e3_e5_att)
            new_e4 = torch.mm(e4, self.W2) + torch.relu(e41*e4_e1_att + e42*e4_e2_att + e43*e4_e3_att + e44*e4_e4_att + e45*e4_e5_att)
            new_e5 = torch.mm(e5, self.W2) + torch.relu(e51*e5_e1_att + e52*e5_e2_att + e53*e5_e3_att + e54*e5_e4_att + e55*e5_e5_att)
            ...
            r = torch.mm(r, self.W3) + torch.relu(re1 * re1_att.view(-1, 1) + re2 * re2_att.view(-1, 1) + re3 * re3_att.view(-1, 1) + re4 * re4_att.view(-1, 1) + re5 * re5_att.view(-1, 1) + re6 * re6_att.view(-1, 1))


            new_e1 = torch.mm(e1, self.W2) + torch.relu(e11*e1_e1_att + e12*e1_e2_att + e13*e1_e3_att + e14*e1_e4_att + e15*e1_e5_att + e16*e1_e6_att)
            new_e2 = torch.mm(e2, self.W2) + torch.relu(e21*e2_e1_att + e22*e2_e2_att + e23*e2_e3_att + e24*e2_e4_att + e25*e2_e5_att + e26*e2_e6_att)
            new_e3 = torch.mm(e3, self.W2) + torch.relu(e31*e3_e1_att + e32*e3_e2_att + e33*e3_e3_att + e34*e3_e4_att + e35*e3_e5_att + e36*e3_e6_att)
            new_e4 = torch.mm(e4, self.W2) + torch.relu(e41*e4_e1_att + e42*e4_e2_att + e43*e4_e3_att + e44*e4_e4_att + e45*e4_e5_att + e46*e4_e6_att)
            new_e5 = torch.mm(e5, self.W2) + torch.relu(e51*e5_e1_att + e52*e5_e2_att + e53*e5_e3_att + e54*e5_e4_att + e55*e5_e5_att + e56*e5_e6_att)
            new_e6 = torch.mm(e6, self.W2) + torch.relu(e61*e6_e1_att + e62*e6_e2_att + e63*e6_e3_att + e64*e6_e4_att + e65*e6_e5_att + e66*e6_e6_att)
            ...
            r = torch.mm(r, self.W3) + torch.relu(re1 * re1_att.view(-1, 1) + re2 * re2_att.view(-1, 1) + re3 * re3_att.view(-1, 1) + re4 * re4_att.view(-1, 1) + re5 * re5_att.view(-1, 1) + re6 * re6_att.view(-1, 1) + re7 * re7_att.view(-1, 1))


            new_e1 = torch.mm(e1, self.W2) + torch.relu(e11*e1_e1_att + e12*e1_e2_att + e13*e1_e3_att + e14*e1_e4_att + e15*e1_e5_att + e16*e1_e6_att + e17*e1_e7_att)
            new_e2 = torch.mm(e2, self.W2) + torch.relu(e21*e2_e1_att + e22*e2_e2_att + e23*e2_e3_att + e24*e2_e4_att + e25*e2_e5_att + e26*e2_e6_att + e27*e2_e7_att)
            new_e3 = torch.mm(e3, self.W2) + torch.relu(e31*e3_e1_att + e32*e3_e2_att + e33*e3_e3_att + e34*e3_e4_att + e35*e3_e5_att + e36*e3_e6_att + e37*e3_e7_att)
            new_e4 = torch.mm(e4, self.W2) + torch.relu(e41*e4_e1_att + e42*e4_e2_att + e43*e4_e3_att + e44*e4_e4_att + e45*e4_e5_att + e46*e4_e6_att + e47*e4_e7_att)
            new_e5 = torch.mm(e5, self.W2) + torch.relu(e51*e5_e1_att + e52*e5_e2_att + e53*e5_e3_att + e54*e5_e4_att + e55*e5_e5_att + e56*e5_e6_att + e57*e5_e7_att)
            new_e6 = torch.mm(e6, self.W2) + torch.relu(e61*e6_e1_att + e62*e6_e2_att + e63*e6_e3_att + e64*e6_e4_att + e65*e6_e5_att + e66*e6_e6_att + e67*e6_e7_att)
            new_e7 = torch.mm(e7, self.W2) + torch.relu(e71*e7_e1_att + e72*e7_e2_att + e73*e7_e3_att + e74*e7_e4_att + e75*e7_e5_att + e76*e7_e6_att + e77*e7_e7_att)
            ...
            r = torch.mm(r, self.W3) + torch.relu(re1 * re1_att.view(-1, 1) + re2 * re2_att.view(-1, 1) + re3 * re3_att.view(-1, 1) + re4 * re4_att.view(-1, 1) + re5 * re5_att.view(-1, 1) + re6 * re6_att.view(-1, 1) + re7 * re7_att.view(-1, 1) + re8 * re8_att.view(-1, 1))

            new_e1 = torch.mm(e1, self.W2) + torch.relu(e11*e1_e1_att + e12*e1_e2_att + e13*e1_e3_att + e14*e1_e4_att + e15*e1_e5_att + e16*e1_e6_att + e17*e1_e7_att + e18*e1_e8_att)
            new_e2 = torch.mm(e2, self.W2) + torch.relu(e21*e2_e1_att + e22*e2_e2_att + e23*e2_e3_att + e24*e2_e4_att + e25*e2_e5_att + e26*e2_e6_att + e27*e2_e7_att + e28*e2_e8_att)
            new_e3 = torch.mm(e3, self.W2) + torch.relu(e31*e3_e1_att + e32*e3_e2_att + e33*e3_e3_att + e34*e3_e4_att + e35*e3_e5_att + e36*e3_e6_att + e37*e3_e7_att + e38*e3_e8_att)
            new_e4 = torch.mm(e4, self.W2) + torch.relu(e41*e4_e1_att + e42*e4_e2_att + e43*e4_e3_att + e44*e4_e4_att + e45*e4_e5_att + e46*e4_e6_att + e47*e4_e7_att + e48*e4_e8_att)
            new_e5 = torch.mm(e5, self.W2) + torch.relu(e51*e5_e1_att + e52*e5_e2_att + e53*e5_e3_att + e54*e5_e4_att + e55*e5_e5_att + e56*e5_e6_att + e57*e5_e7_att + e58*e5_e8_att)
            new_e6 = torch.mm(e6, self.W2) + torch.relu(e61*e6_e1_att + e62*e6_e2_att + e63*e6_e3_att + e64*e6_e4_att + e65*e6_e5_att + e66*e6_e6_att + e67*e6_e7_att + e68*e6_e8_att)
            new_e7 = torch.mm(e7, self.W2) + torch.relu(e71*e7_e1_att + e72*e7_e2_att + e73*e7_e3_att + e74*e7_e4_att + e75*e7_e5_att + e76*e7_e6_att + e77*e7_e7_att + e78*e7_e8_att)
            new_e8 = torch.mm(e8, self.W2) + torch.relu(e81*e8_e1_att + e82*e8_e2_att + e83*e8_e3_att + e84*e8_e4_att + e85*e8_e5_att + e86*e8_e6_att + e87*e8_e7_att + e88*e8_e8_att)
            ...
            new_e1 = torch.mm(e1, self.W2) + torch.relu(e11*e1_e1_att + e12*e1_e2_att + e13*e1_e3_att + e14*e1_e4_att + e15*e1_e5_att + e16*e1_e6_att + e17*e1_e7_att + e18*e1_e8_att + e19*e1_e9_att)
            new_e2 = torch.mm(e2, self.W2) + torch.relu(e21*e2_e1_att + e22*e2_e2_att + e23*e2_e3_att + e24*e2_e4_att + e25*e2_e5_att + e26*e2_e6_att + e27*e2_e7_att + e28*e2_e8_att + e29*e2_e9_att)
            new_e3 = torch.mm(e3, self.W2) + torch.relu(e31*e3_e1_att + e32*e3_e2_att + e33*e3_e3_att + e34*e3_e4_att + e35*e3_e5_att + e36*e3_e6_att + e37*e3_e7_att + e38*e3_e8_att + e39*e3_e9_att)
            new_e4 = torch.mm(e4, self.W2) + torch.relu(e41*e4_e1_att + e42*e4_e2_att + e43*e4_e3_att + e44*e4_e4_att + e45*e4_e5_att + e46*e4_e6_att + e47*e4_e7_att + e48*e4_e8_att + e49*e4_e9_att)
            new_e5 = torch.mm(e5, self.W2) + torch.relu(e51*e5_e1_att + e52*e5_e2_att + e53*e5_e3_att + e54*e5_e4_att + e55*e5_e5_att + e56*e5_e6_att + e57*e5_e7_att + e58*e5_e8_att + e59*e5_e9_att)
            new_e6 = torch.mm(e6, self.W2) + torch.relu(e61*e6_e1_att + e62*e6_e2_att + e63*e6_e3_att + e64*e6_e4_att + e65*e6_e5_att + e66*e6_e6_att + e67*e6_e7_att + e68*e6_e8_att + e69*e6_e9_att)
            new_e7 = torch.mm(e7, self.W2) + torch.relu(e71*e7_e1_att + e72*e7_e2_att + e73*e7_e3_att + e74*e7_e4_att + e75*e7_e5_att + e76*e7_e6_att + e77*e7_e7_att + e78*e7_e8_att + e79*e7_e9_att)
            new_e8 = torch.mm(e8, self.W2) + torch.relu(e81*e8_e1_att + e82*e8_e2_att + e83*e8_e3_att + e84*e8_e4_att + e85*e8_e5_att + e86*e8_e6_att + e87*e8_e7_att + e88*e8_e8_att + e89*e8_e9_att)
            new_e9 = torch.mm(e9, self.W2) + torch.relu(e91*e9_e1_att + e92*e9_e2_att + e93*e9_e3_att + e94*e9_e4_att + e95*e9_e5_att + e96*e9_e6_att + e97*e9_e7_att + e98*e9_e8_att + e99*e9_e9_att)
            ...
            r = torch.mm(r, self.W3) + torch.relu(re1 * re1_att.view(-1, 1) + re2 * re2_att.view(-1, 1) + re3 * re3_att.view(-1, 1) + re4 * re4_att.view(-1, 1) + re5 * re5_att.view(-1, 1) + re6 * re6_att.view(-1, 1) + re7 * re7_att.view(-1, 1) + re8 * re8_att.view(-1, 1) + re9 * re9_att.view(-1, 1))
