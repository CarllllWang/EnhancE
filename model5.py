...
class HyperNet(BaseClass):
    def __init__(self, dataset, emb_dim, hidden_drop):
        ...
        xavier_uniform_(self.W0.data)
        xavier_uniform_(self.a.data)
        xavier_uniform_(self.W1.data)
        xavier_uniform_(self.W2.data)
        xavier_uniform_(self.W3.data)
    ...
    def forward(self, batch, ms, bs):
        ...
        if batch.shape[1] == 3:
            ...
            r = torch.mm(r, self.W3) + self.relu6(re1*re1_att.view(-1, 1) + re2*re2_att.view(-1, 1))
            ...
            e1_e2_att = torch.exp(e12_m) / (torch.exp(e12_m))
            e2_e1_att = torch.exp(e21_m) / (torch.exp(e21_m))

            new_e1 = torch.mm(e1, self.W2) + self.relu6(e12*e1_e2_att)
            new_e2 = torch.mm(e2, self.W2) + self.relu6(e21*e2_e1_att)
            ...
            e1_e2_att = torch.exp(e12_m) / (torch.exp(e12_m) + torch.exp(e13_m))
            e1_e3_att = torch.exp(e13_m) / (torch.exp(e12_m) + torch.exp(e13_m))
            e2_e1_att = torch.exp(e21_m) / (torch.exp(e21_m) + torch.exp(e23_m))
            e2_e3_att = torch.exp(e23_m) / (torch.exp(e21_m) + torch.exp(e23_m))
            e3_e1_att = torch.exp(e31_m) / (torch.exp(e31_m) + torch.exp(e32_m))
            e3_e2_att = torch.exp(e32_m) / (torch.exp(e31_m) + torch.exp(e32_m))


            new_e1 = torch.mm(e1, self.W2) + torch.tanh(e2*e1_e2_att + e3*e1_e3_att)
            new_e2 = torch.mm(e2, self.W2) + torch.tanh(e1*e2_e1_att + e3*e2_e3_att)
            new_e3 = torch.mm(e3, self.W2) + torch.tanh(e1*e3_e1_att + e2*e3_e2_att)
            ...
            e1_e2_att = torch.exp(e12_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m))
            e1_e3_att = torch.exp(e13_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m))
            e1_e4_att = torch.exp(e14_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m))
            e2_e1_att = torch.exp(e21_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m))
            e2_e3_att = torch.exp(e23_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m))
            e2_e4_att = torch.exp(e24_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m))
            e3_e1_att = torch.exp(e31_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m))
            e3_e2_att = torch.exp(e32_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m))
            e3_e4_att = torch.exp(e34_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m))
            e4_e1_att = torch.exp(e41_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m))
            e4_e2_att = torch.exp(e42_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m))
            e4_e3_att = torch.exp(e43_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m))
            ...
            e1_e2_att = torch.exp(e12_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m) + torch.exp(e15_m))
            e1_e3_att = torch.exp(e13_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m) + torch.exp(e15_m))
            e1_e4_att = torch.exp(e14_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m) + torch.exp(e15_m))
            e1_e5_att = torch.exp(e15_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m) + torch.exp(e15_m))
            e2_e1_att = torch.exp(e21_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m) + torch.exp(e25_m))
            e2_e3_att = torch.exp(e23_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m) + torch.exp(e25_m))
            e2_e4_att = torch.exp(e24_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m) + torch.exp(e25_m))
            e2_e5_att = torch.exp(e25_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m) + torch.exp(e25_m))
            e3_e1_att = torch.exp(e31_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m) + torch.exp(e35_m))
            e3_e2_att = torch.exp(e32_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m) + torch.exp(e35_m))
            e3_e4_att = torch.exp(e34_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m) + torch.exp(e35_m))
            e3_e5_att = torch.exp(e35_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m) + torch.exp(e35_m))
            e4_e1_att = torch.exp(e41_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m) + torch.exp(e45_m))
            e4_e2_att = torch.exp(e42_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m) + torch.exp(e45_m))
            e4_e3_att = torch.exp(e43_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m) + torch.exp(e45_m))
            e4_e5_att = torch.exp(e45_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m) + torch.exp(e45_m))
            e5_e1_att = torch.exp(e51_m) / (torch.exp(e51_m) + torch.exp(e52_m) + torch.exp(e53_m) + torch.exp(e54_m))
            e5_e2_att = torch.exp(e52_m) / (torch.exp(e51_m) + torch.exp(e52_m) + torch.exp(e53_m) + torch.exp(e54_m))
            e5_e3_att = torch.exp(e53_m) / (torch.exp(e51_m) + torch.exp(e52_m) + torch.exp(e53_m) + torch.exp(e54_m))
            e5_e4_att = torch.exp(e54_m) / (torch.exp(e51_m) + torch.exp(e52_m) + torch.exp(e53_m) + torch.exp(e54_m))
            ...
            e1_e2_att = torch.exp(e12_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m) + torch.exp(e15_m) + torch.exp(e16_m))
            e1_e3_att = torch.exp(e13_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m) + torch.exp(e15_m) + torch.exp(e16_m))
            e1_e4_att = torch.exp(e14_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m) + torch.exp(e15_m) + torch.exp(e16_m))
            e1_e5_att = torch.exp(e15_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m) + torch.exp(e15_m) + torch.exp(e16_m))
            e1_e6_att = torch.exp(e16_m) / (torch.exp(e12_m) + torch.exp(e13_m) + torch.exp(e14_m) + torch.exp(e15_m) + torch.exp(e16_m))
            e2_e1_att = torch.exp(e21_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m) + torch.exp(e25_m) + torch.exp(e26_m))
            e2_e3_att = torch.exp(e23_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m) + torch.exp(e25_m) + torch.exp(e26_m))
            e2_e4_att = torch.exp(e24_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m) + torch.exp(e25_m) + torch.exp(e26_m))
            e2_e5_att = torch.exp(e25_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m) + torch.exp(e25_m) + torch.exp(e26_m))
            e2_e6_att = torch.exp(e26_m) / (torch.exp(e21_m) + torch.exp(e23_m) + torch.exp(e24_m) + torch.exp(e25_m) + torch.exp(e26_m))
            e3_e1_att = torch.exp(e31_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m) + torch.exp(e35_m) + torch.exp(e36_m))
            e3_e2_att = torch.exp(e32_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m) + torch.exp(e35_m) + torch.exp(e36_m))
            e3_e4_att = torch.exp(e34_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m) + torch.exp(e35_m) + torch.exp(e36_m))
            e3_e5_att = torch.exp(e35_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m) + torch.exp(e35_m) + torch.exp(e36_m))
            e3_e6_att = torch.exp(e36_m) / (torch.exp(e31_m) + torch.exp(e32_m) + torch.exp(e34_m) + torch.exp(e35_m) + torch.exp(e36_m))
            e4_e1_att = torch.exp(e41_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m) + torch.exp(e45_m) + torch.exp(e46_m))
            e4_e2_att = torch.exp(e42_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m) + torch.exp(e45_m) + torch.exp(e46_m))
            e4_e3_att = torch.exp(e43_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m) + torch.exp(e45_m) + torch.exp(e46_m))
            e4_e5_att = torch.exp(e45_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m) + torch.exp(e45_m) + torch.exp(e46_m))
            e4_e6_att = torch.exp(e46_m) / (torch.exp(e41_m) + torch.exp(e42_m) + torch.exp(e43_m) + torch.exp(e45_m) + torch.exp(e46_m))
            e5_e1_att = torch.exp(e51_m) / (torch.exp(e51_m) + torch.exp(e52_m) + torch.exp(e53_m) + torch.exp(e54_m) + torch.exp(e56_m))
            e5_e2_att = torch.exp(e52_m) / (torch.exp(e51_m) + torch.exp(e52_m) + torch.exp(e53_m) + torch.exp(e54_m) + torch.exp(e56_m))
            e5_e3_att = torch.exp(e53_m) / (torch.exp(e51_m) + torch.exp(e52_m) + torch.exp(e53_m) + torch.exp(e54_m) + torch.exp(e56_m))
            e5_e4_att = torch.exp(e54_m) / (torch.exp(e51_m) + torch.exp(e52_m) + torch.exp(e53_m) + torch.exp(e54_m) + torch.exp(e56_m))
            e5_e6_att = torch.exp(e56_m) / (torch.exp(e51_m) + torch.exp(e52_m) + torch.exp(e53_m) + torch.exp(e54_m) + torch.exp(e56_m))
            e6_e1_att = torch.exp(e61_m) / (torch.exp(e61_m) + torch.exp(e62_m) + torch.exp(e63_m) + torch.exp(e64_m) + torch.exp(e65_m))
            e6_e2_att = torch.exp(e62_m) / (torch.exp(e61_m) + torch.exp(e62_m) + torch.exp(e63_m) + torch.exp(e64_m) + torch.exp(e65_m))
            e6_e3_att = torch.exp(e63_m) / (torch.exp(e61_m) + torch.exp(e62_m) + torch.exp(e63_m) + torch.exp(e64_m) + torch.exp(e65_m))
            e6_e4_att = torch.exp(e64_m) / (torch.exp(e61_m) + torch.exp(e62_m) + torch.exp(e63_m) + torch.exp(e64_m) + torch.exp(e65_m))
            e6_e5_att = torch.exp(e65_m) / (torch.exp(e61_m) + torch.exp(e62_m) + torch.exp(e63_m) + torch.exp(e64_m) + torch.exp(e65_m))
